              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "0.5rem" }}>
                ...
                >
                  ...
                  <svg width="18" height="18" viewBox="0 0 18 18">
                    ...
                    <path fill="currentColor" d="M9 18c2.43 0 4.467-.806 6.168-2.172l-2.908-2.258c-.806.54-1.837.86-3.26.86-2.513 0-4.646-1.697-5.41-4.043H.957v2.332C2.438 15.983 5.482 18 9 18z"/>
                    <path fill="currentColor" d="M3.59 10.387c-.18-.54-.282-1.117-.282-1.71 0-.593.102-1.17.282-1.71V4.645H.957C.347 5.863 0 7.167 0 8.5c0 1.333.348 2.637.957 3.855l2.633-1.968z"/>
                    <path fill="currentColor" d="M9 3.58c1.321 0 2.508.454 3.44 1.345l2.582-2.58C13.463.891 11.426 0 9 0 5.482 0 2.438 2.017.957 4.645L3.59 6.977C4.354 4.633 6.487 2.936 9 2.936z"/>
                  </svg>
                  Sign in with Google
                    </>
                  )}
